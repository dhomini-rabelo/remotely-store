...
class TestRegisterAPI:
    ...
    def test_api_with_empty_body(self, simple_client: Client):
    ...
    def test_api_without_email(self, simple_client: Client):
    ...
    def test_api_without_password(self, simple_client: Client):
    ...
    def test_api_without_confirm_password(self, simple_client: Client):
    ...
    def test_api_with_different_passwords(self, simple_client: Client):
    ...
    def test_api_when_success(self, simple_client: Client):
        response = simple_client.post(
            self.ROUTE,
            self.VALID_DATA,
        )
    ...
    def test_api_unique_email_error(self, simple_client: Client):
